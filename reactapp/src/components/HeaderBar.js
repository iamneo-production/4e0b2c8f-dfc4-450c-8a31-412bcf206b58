                        ...
                        {props.isLandingPage?
                            ...
                            :<Group>
                                <Menu trigger="hover" openDelay={100} shadow="md" width={200}>
                                    ...
                                    <Menu.Dropdown >
                                        <Menu.Item transitionProps={{ transition: 'slide-down', duration: 150 }} onClick={()=>{handleSetting()}} icon={<SettingIcon style={{height:"16px",width:"16px"}}/>}><Text size={"sm"}>Setting</Text></Menu.Item>
                                        <Menu.Divider />
